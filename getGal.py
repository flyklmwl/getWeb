...
def webpasre():
    ...
    robot001.connectpage("https://www.9moe.com/", headers=config.headers)
    ...
    for item in items:
        ...
        tz_type = robot001.get_item("div.drow:nth-child(3) > div:nth-child(1) > form:nth-child(2) > div:nth-child(5)"
