...
def main():
    ...
    robot004 = robot.TieBaRobot("http://tieba.baidu.com/hottopic/browse/topicList")
    tieba_data = robot004.parse()
    bs.save_data(tieba_data, "link")
    bs.packaging_mes("title", "link")
    bs.send_message()

    robot005 = robot.TieBa2Robot("https://tieba.baidu.com/f?kw=%E7%BB%8F%E5%85%B8jrpg&fr=index", "经典jrpg")
    ...
    robot007 = robot.TieBa2Robot("https://tieba.baidu.com/f?kw=%E7%AC%91%E8%AF%9D", "笑话吧")
